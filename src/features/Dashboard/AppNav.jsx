...
function AppNav() {
  return (
    <nav className="fixed left-0 right-0 px-2 sm:px-20 sm:py-3 py-1 bottom-0 bg-indigo-100 drop-shadow-md ">
      <ul className="flex items-center justify-between">
        ...
        >
          <IoWalletOutline className="text-xl sm:text-2xl" />
        ...
        >
          <IoPieChartOutline className="text-xl sm:text-2xl" />
